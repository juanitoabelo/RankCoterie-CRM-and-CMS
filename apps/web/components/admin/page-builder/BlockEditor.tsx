      ...
      {activeTab === "content" && (
        <div className="space-y-3">
          ...
          <div>
            ...
            <textarea className={inputCls + " min-h-[80px]"} value={p.text} onChange={(e) => set({ text: e.target.value })} placeholder="Enter heading text" />
          </div>

          <div>
            <label className={labelCls}>Link</label>
            <input type="url" className={inputCls} value={p.link || ""} onChange={(e) => set({ link: e.target.value })} placeholder="https://example.com" />
          </div>
