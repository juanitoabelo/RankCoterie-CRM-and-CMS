...
import { BlogTemplateBlockRenderer, BlogDataContext } from "./BlogTemplateRenderer";
...
export default function BlogTemplateCanvas({
  blocks,
  viewport,
  containerSettings,
  selectedId,
  ...
  return (
    <BlogDataContext.Provider value={{ viewport }}>
    <div
      ref={setNodeRef}
